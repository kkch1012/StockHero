...
export function PaywallModal({ isOpen, onClose, title, price }: PaywallModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div
        className="relative bg-dark-900 border border-dark-700 rounded-2xl shadow-2xl max-w-md w-full animate-fade-up"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <div className="p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h2 id="paywall-modal-title" className="text-xl font-bold text-dark-50 mb-2">Complete Purchase</h2>
